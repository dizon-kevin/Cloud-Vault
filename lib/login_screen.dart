    ...
    showCupertinoDialog(
      ...
      builder: (BuildContext context) {
        return CupertinoAlertDialog(
          title: const Text(
            'Team Members',
            style: TextStyle(fontSize: 20, fontWeight: FontWeight.bold), // Increased font size and made it bold
          ),
          content: const Column(
            crossAxisAlignment: CrossAxisAlignment.start,
            children: [
              Text('Cruz, John Eric', style: TextStyle(fontSize: 16)), // Increased font size
              Text('Dizon Kevin', style: TextStyle(fontSize: 16)), // Increased font size
              Text('Juanatas Cris', style: TextStyle(fontSize: 16)), // Increased font size
              Text('Jenzelle Luriz', style: TextStyle(fontSize: 16)), // Increased font size
              Text('Marc Lawrence', style: TextStyle(fontSize: 16)), // Increased font size
              Text('Charles Venasquez', style: TextStyle(fontSize: 16)), // Increased font size
            ],
          ),
          actions: <Widget>[
            CupertinoDialogAction(
              child: const Text('Close', style: TextStyle(fontSize: 16)), // Increased font size
              onPressed: () {
    ...
    return CupertinoPageScaffold(
      ...
      navigationBar: CupertinoNavigationBar(
        trailing: CupertinoButton(
          ...
          child: const Icon(CupertinoIcons.group_solid, size: 30), // Increased icon size
          onPressed: () {
